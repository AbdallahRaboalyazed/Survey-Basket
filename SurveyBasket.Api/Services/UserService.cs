...
public class UserService(UserManager<ApplicationUser> userManager , AppDBcontext context  , IRoleService roleService) : IUserService
{
    ...
    // Get all the users with thier roles
    ...
    on u.Id equals ur.UserId
              ...
              select new
              {
               ...
               (
                   ...
                   u.Key.Email,
                   u.Key.IsDisabled,
                   u.SelectMany(x => x.Roles) // because we have a list of roles
               ))
    ...
    public async Task<Result<UserResponse>> GetAsync(string id)
    {
        ...
        // instead of creating a new instance of UserResponse and assign the values like this 
        /*
