...
public interface IPollService
{
    ...
    Task<IEnumerable<PollResponse>> GetCurrentPollAsync(CancellationToken cancellationToken = default);
    ...
    Task<Result> ToggleIsPpublishedAsync(int id, CancellationToken cancellationToken = default);
